...
var fsNativePlugin = {
	...
	init: function(callback)
	{
		...
		//this.port = chrome.runtime.connectNative('com.getCodeNinjas.debug.api');
		this.port = chrome.runtime.connectNative('com.getCodeNinjas.api');
	...
	doUpdate: function()
	{
		...
		this.getFile("native/CodeNinjas-chrome-plugin.exe", function(data) {
			this.updating = true;
